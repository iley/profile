...
for extra_path in "$HOME/bin" "$HOME/.local/bin" "$HOME/.npm-packages/bin" "$HOME/go/bin" "$HOME/.local/bin" "$HOME/.cargo/bin" "$HOME/flutter/bin" "/opt/homebrew/bin" "/opt/homebrew/opt/llvm/bin"; do
